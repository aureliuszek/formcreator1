...
export class Form {
     fieldsArray : Field[] = [new DateField("Data formularza") ,new InputField("Imię"), new InputField("Nazwisko"), new EmailField("Email"), new SelectField("Wybierz" , ["Pierwsza Opcja", "Druga Opcja"]), new CheckboxField("Czy Preferujesz e-learning?"),new TextAreaField("Uwagi")];
